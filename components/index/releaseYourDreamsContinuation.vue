...
export default {
  data: () => {
    return {
      courses1: [
        "Cadastros e operações nas casas de investimentos",
        "Uso correto de calculadoras",
        "Controle emocional/ Gestão de banca",
        "Estratégias conservadoras e arrojadas",
      ],
      courses2: [
        "Investimentos em futebol e outras modalidades",
